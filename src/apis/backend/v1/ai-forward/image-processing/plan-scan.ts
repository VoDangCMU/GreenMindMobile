...
export default async function planScan(photo: Photo): Promise<AnalyzeImagePlantResult> {
    ...
    return BackendInstance.post("/healthy-food-ratio", formData, { headers: authHeader() }).then(res => res.data as AnalyzeImagePlantResult);
}
