...
import { ArrowLeft, Target, Plus, CheckCircle2, Calendar, Leaf, Heart, DollarSign, Users } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-greenery-50 to-greenery-100 p-4">
      <div className="max-w-sm mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <h1 className="text-lg font-bold text-greenery-700">My Goals</h1>
          <Button variant="ghost" onClick={() => setShowAddGoal(true)} className="p-2">
            <Plus className="w-5 h-5 text-greenery-700" />
          </Button>
        </div>
        ...
        <div className="mt-6 space-y-3">
          <Link to="/tracking">
            ...
            >
              Track Activities to Update Goals
            </Button>
          </Link>
        </div>
      </div>
