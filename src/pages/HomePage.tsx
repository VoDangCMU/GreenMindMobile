...
export default function HomePage() {
	...
	// Dùng kiểu any cho listenerHandle để tránh lỗi typescript
	useEffect(() => {
	...
	return (
		<div
			className="min-h-screen bg-gradient-to-br from-greenery-50 to-greenery-100 flex flex-col p-0"
			style={{ paddingTop: "calc(64px + env(safe-area-inset-top, 16px))" }}
		>
			<AppHeader />
			{showToast && (
				<div className="fixed bottom-10 left-1/2 -translate-x-1/2 bg-greenery-700 text-white px-4 py-2 rounded-xl shadow z-50 animate-fade-in">
